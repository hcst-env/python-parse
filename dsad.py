...
def get_data():
    ...
    proces = input("Do you want to get new data? (y/n): ")
    if proces.lower() == "n":
...
def date_picker():
    custom_date = input("Do you want a custom date? (yes/no): ")
    ...
    custom_end_date = input("Do you want a custom end date? (yes/no): ")
